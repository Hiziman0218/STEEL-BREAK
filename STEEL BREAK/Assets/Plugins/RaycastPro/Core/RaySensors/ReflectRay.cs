namespace RaycastPro.RaySensors
{
    ...
    public sealed class ReflectRay : PathRay, IRadius
    {
        ...
        [Tooltip("レイが反射できる回数を指定します。指定回数に達すると反射は停止します。負の数を設定すると、方向に制限のない無制限モードになります。")]
        ...
        internal override string Info => "反射レイを <i>Reflect レイヤー</i> に向けて発射し、<i>Detect レイヤー</i> における衝突地点を検出します。" + HAccurate + HPathRay + HRecursive+HIRadius;
