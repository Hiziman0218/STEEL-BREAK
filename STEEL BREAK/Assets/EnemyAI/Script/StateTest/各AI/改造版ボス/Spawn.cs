    ...
    public class Spawn_T : State<Titania_T>
    {
        ...
        public void EnemySpwon(bool Flag)
        {
            ...
            else
            {
                ...
                if (Dummy.GetComponent<StateMachineAI.FairysAI>())
                    GameObject.Destroy(Dummy.GetComponent<StateMachineAI.FairysAI>());
                ...
                Dummy.GetComponent<RootMove>().m_RootTaerget = GameObject.Find("回るポイント").transform;
