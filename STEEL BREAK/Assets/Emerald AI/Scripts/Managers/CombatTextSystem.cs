...
namespace EmeraldAI
{
    /// <summary>
    /// 【CombatTextSystem】
    /// ダメージ数値や回復量などの「コンバットテキスト」を生成・表示・アニメーションさせるシステム。
    /// ・Resources からプレハブ／設定データをロード
    /// ・VR／通常表示に応じて Canvas 設定を自動切替
    /// ・種別に応じたアニメーション（Bounce/Upwards/Outwards/Stationary）を再生
    /// </summary>
    public class CombatTextSystem : MonoBehaviour
    {
        [Header("シングルトン参照（このシステムの唯一のインスタンス）")]
        public static CombatTextSystem Instance;

        [Header("コンバットテキストのプレハブ（Resources/\"Combat Text\" をロード）")]
        [HideInInspector]
        ...
        /// <summary>
        /// 必要なプレハブ／データのロードと Canvas 設定（通常/VR）を行います。
        /// </summary>
        ...
        /// <summary>
        /// プレイヤー向けのコンバットテキストを生成します。
        /// </summary>
        /// <param name="amount">表示する数値（ダメージ/回復量）</param>
        /// <param name="TextPosition">ワールド座標での基準位置</param>
        /// <param name="CriticalHit">クリティカル表示か</param>
        /// <param name="HealingText">回復テキストか</param>
        /// <param name="PlayerTakingDamage">プレイヤーが被ダメージ中か</param>
        ...
        /// <summary>
        /// 【Bounce】跳ねるアニメーションで数値を表示します。
        /// クリティカル／回復／被ダメージ中などの色や接頭辞（+/-）を反映します。
        /// </summary>
        ...
        /// <summary>
        /// 【Upwards】上方へ浮かび上がるアニメーションで数値を表示します。
        /// </summary>
        ...
        /// <summary>
        /// 【OutwardsV1/V2】外側へ拡散するアニメーションで数値を表示します。
        /// </summary>
        ...
        /// <summary>
        /// 【Stationary】その場に固定してフェードアウトするアニメーションで数値を表示します。
        /// </summary>
        ...
        /// <summary>
        /// VR 表示時、テキストをカメラ方向へ回転させて常に正面を向かせます。
        /// </summary>
